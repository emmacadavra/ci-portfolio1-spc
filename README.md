...
* Throughout the page, there are 3 fonts used:
    ...
    * Roboto Slab
​
* The ‘Playfair Display’ font was chosen to match the Sheffield Philharmonic Chorus logo (featured in the ‘Join Us’ sections of the site) and is used for the site title and section headers.
...
* All fonts were sourced from Google Fonts, as stated in the [**'Credits'**](#credits) section.
...
An animation has been added to the hamburger menu which turns it from the traditional three lines when closed, into a large X when it is open. This makes it feel even more interactive, and makes it clear to users that they can close the menu again by clicking on the familiar transformed shape.
...
As with Section One, Section Two is divided into two parts - a large image, and the content. For this section, when viewing on a screen that has a width of at least 1280px, the order of the content and image has switched. This has been done using Flexbox, and means that the section is visually engaging, while avoiding having all text on one side of the website which would look messy and unappealing. 
...
Section Three appears visually different from Sections One and Two, again to keep the user visually engaged. It features a fixed background image of a sheet music booklet, which is relevant to the choir's activities, and also subtle enough not to interfere with the foreground. The decision to keep the image in a fixed position was the result of testing the website's responsive design on mobile and small tablet widths. More information about this can be found in the **'Bugs'** section of the separate TESTING.md file linked in the [**Testing**](#testing) section further down in this document.
...
The Form Submission page's confirmation box utilises the same colour scheme as the header and footer. It serves as confirmation to the user that they have correctly filled in the form, and that someone will be in touch with them soon.

![Form Submission page confirmation text](docs/images/form-submission-thankyou.png)
...
![Form Submission page images on screens at least 1050px wide](docs/images/form-submission-rehearsal-photos-nowrap.png)
...
![Form Submission page images on screens below 550px wide](docs/images/form-submission-rehearsal-photos-wrap-mobile.png)

![Form Submission page images on screens between 550px and 1050px wide](docs/images/form-submission-rehearsal-photos-wrap-tablet.png)
...
A disclaimer has been added to the very bottom of the footer, explaining that this website is for education purposes only.
